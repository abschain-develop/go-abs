...
func TestIPCPathResolution(t *testing.T) {
	var tests = []struct {
		...
		{"", "", false, ""},
		{"data", "", false, ""},
		{"", "gabs.ipc", false, filepath.Join(os.TempDir(), "gabs.ipc")},
		{"data", "gabs.ipc", false, "data/gabs.ipc"},
		{"data", "./gabs.ipc", false, "./gabs.ipc"},
		{"data", "/gabs.ipc", false, "/gabs.ipc"},
		{"", "", true, ``},
		{"data", "", true, ``},
		{"", "gabs.ipc", true, `\\.\pipe\gabs.ipc`},
		{"data", "gabs.ipc", true, `\\.\pipe\gabs.ipc`},
		{"data", `\\.\pipe\gabs.ipc`, true, `\\.\pipe\gabs.ipc`},
	}
