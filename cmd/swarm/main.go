...
import (
	...
	"github.com/abschain-develop/go-abs/cmd/utils"
	"github.com/abschain-develop/go-abs/common"
	"github.com/abschain-develop/go-abs/console"
	"github.com/abschain-develop/go-abs/crypto"
	"github.com/abschain-develop/go-abs/internal/debug"
	...
	"github.com/abschain-develop/go-abs/swarm"
	bzzapi "github.com/abschain-develop/go-abs/swarm/api"
	swarmmetrics "github.com/abschain-develop/go-abs/swarm/metrics"
	"github.com/abschain-develop/go-abs/swarm/storage/mock"
	mockrpc "github.com/abschain-develop/go-abs/swarm/storage/mock/rpc"
...
// This init function sets defaults so cmd/swarm can run alongside gabs.
func init() {
...
func bzzd(ctx *cli.Context) error {
	...
	//gabs only supports --datadir via command line
	//in order to be consistent within swarm, if we pass --datadir via environment variable
	//or via config file, we get the same directory for gabs and swarm
