...
import (
	...
	"github.com/abschain-develop/go-abs/common/mclock"
	"github.com/abschain-develop/go-abs/common/prque"
	...
	"github.com/abschain-develop/go-abs/trie"
...
func (bc *BlockChain) insertChain(chain types.Blocks, verifySeals bool) (int, []interface{}, []*types.Log, error) {
	...
	if errChain != nil {
		...
		return 0, events, coalescedLogs, ErrPenaltyInChain
	}
