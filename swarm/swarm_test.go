...
func TestParseEnsAPIAddress(t *testing.T) {
	for _, x := range []struct {
	...
	}{
		{
			...
			value:       "/data/testnet/gabs.ipc",
			endpoint:    "/data/testnet/gabs.ipc",
		},
		{
		...
		},
		{
			...
			value:       "test:/data/testnet/gabs.ipc",
			endpoint:    "/data/testnet/gabs.ipc",
			tld:         "test",
		},
		{
		...
		},
		{
			...
			value:       "314159265dD8dbb310642f98f50C066173C1259b@/data/testnet/gabs.ipc",
			endpoint:    "/data/testnet/gabs.ipc",
		...
		},
		{
			...
			value:       "test:314159265dD8dbb310642f98f50C066173C1259b@/data/testnet/gabs.ipc",
			endpoint:    "/data/testnet/gabs.ipc",
			addr:        common.HexToAddress("314159265dD8dbb310642f98f50C066173C1259b"),
			tld:         "test",
		},
