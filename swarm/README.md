...
Building Swarm requires Go (version 1.10 or later).
    ...
    go get -d github.com/abschain-develop/go-abs

    go install github.com/abschain-develop/go-abs/cmd/swarm
...
You must have your working copy under `$GOPATH/src/github.com/abschain-develop/go-abs`.
...
```
git clone git@github.com:nirname/go-ethereum.git $GOPATH/src/github.com/abschain-develop/go-abs
```
...
```
stateth --rm --grafana-dashboards-folder $GOPATH/src/github.com/abschain-develop/go-abs/swarm/grafana_dashboards --influxdb-database metrics
```
 ...
 * [Code review guidelines](https://github.com/abschain-develop/go-abs/wiki/Code-Review-Guidelines).
