...
var (
	MainnetGenesisHash = common.HexToHash("0x9c3f26c017732df81813557b0bf2e574b63826c002bad0d81f1905ef7d3314cc")
...
var (
	...
	MainnetChainConfig = &ChainConfig{
		...
		EIP150Hash:          common.HexToHash("0x9c3f26c017732df81813557b0bf2e574b63826c002bad0d81f1905ef7d3314cc"),
		EIP155Block:         big.NewInt(1005550),
		EIP158Block:         big.NewInt(1005550),
		ByzantiumBlock:      big.NewInt(238000),
		ConstantinopleBlock: big.NewInt(2238000),
		PetersburgBlock:     big.NewInt(2238000),
	...
	MainnetTrustedCheckpoint = &TrustedCheckpoint{
		Name:         "mainnet",
		SectionIndex: 44,//1,474,559
		SectionHead:  common.HexToHash("0x0ce91ded2858de7e9dc6893e68eff481a53bfc883a7f92e6d516fbfa6c783863"),
		CHTRoot:      common.HexToHash("0x5fcac473747ee3d2c1d0bbd91c067ee2c2e4f823796d9f01d45511402778f0bf"),
		BloomRoot:    common.HexToHash("0xc73720dc1e57d4ed3d2e112d62115cbb750af31b5aa92bfaf48e454f577d7364"),
	}
	...
	TestnetChainConfig = &ChainConfig{
		...
		DAOForkSupport:      false,
		EIP150Block:         big.NewInt(0),
		EIP150Hash:          common.HexToHash("0x9b1961575a2a248e35a1f365e8eaba8d6ea5c0a5b899e3de9fd397e356194c61"),
		EIP155Block:         big.NewInt(10),
		EIP158Block:         big.NewInt(10),
		ByzantiumBlock:      big.NewInt(238000),
		ConstantinopleBlock: big.NewInt(1144800),
		PetersburgBlock:     big.NewInt(1144800),
		Ethash:              new(EthashConfig),
	}
