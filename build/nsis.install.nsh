Name "gabs ${MAJORVERSION}.${MINORVERSION}.${BUILDVERSION}" # VERSION variables set through command line arguments
InstallDir "$InstDir"
OutFile "${OUTPUTFILE}" # set through command line arguments

# Links for "Add/Remove Programs"
!define HELPURL "https://github.com/abschain-develop/go-abs/issues"
!define UPDATEURL "https://github.com/abschain-develop/go-abs/releases"
!define ABOUTURL "https://github.com/abschain-develop/go-abs#ethereum-go"
...
# Install gabs binary
Section "Gabs" GETH_IDX
  SetOutPath $INSTDIR
  file {{.Gabs}}

  # Create start menu launcher
  createDirectory "$SMPROGRAMS\${APPNAME}"
  createShortCut "$SMPROGRAMS\${APPNAME}\${APPNAME}.lnk" "$INSTDIR\gabs.exe" "--fast" "--cache=512"
  createShortCut "$SMPROGRAMS\${APPNAME}\Attach.lnk" "$INSTDIR\gabs.exe" "attach" "" ""
  createShortCut "$SMPROGRAMS\${APPNAME}\Uninstall.lnk" "$INSTDIR\uninstall.exe" "" "" ""

  # Firewall - remove rules (if exists)
  SimpleFC::AdvRemoveRule "Gabs incoming peers (TCP:30303)"
  SimpleFC::AdvRemoveRule "Gabs outgoing peers (TCP:30303)"
  SimpleFC::AdvRemoveRule "Gabs UDP discovery (UDP:30303)"

  # Firewall - add rules
  SimpleFC::AdvAddRule "Gabs incoming peers (TCP:30303)" ""  6 1 1 2147483647 1 "$INSTDIR\gabs.exe" "" "" "Ethereum" 30303 "" "" ""
  SimpleFC::AdvAddRule "Gabs outgoing peers (TCP:30303)" ""  6 2 1 2147483647 1 "$INSTDIR\gabs.exe" "" "" "Ethereum" "" 30303 "" ""
  SimpleFC::AdvAddRule "Gabs UDP discovery (UDP:30303)" "" 17 2 1 2147483647 1 "$INSTDIR\gabs.exe" "" "" "Ethereum" "" 30303 "" ""

  # Set default IPC endpoint (https://github.com/ethereum/EIPs/issues/147)
  ${EnvVarUpdate} $0 "ETHEREUM_SOCKET" "R" "HKLM" "\\.\pipe\gabs.ipc"
  ${EnvVarUpdate} $0 "ETHEREUM_SOCKET" "A" "HKLM" "\\.\pipe\gabs.ipc"
