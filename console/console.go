...
import (
	...
	"github.com/abschain-develop/go-abs/internal/jsre"
	"github.com/abschain-develop/go-abs/internal/web3ext"
...
// Welcome show summary of current Gabs instance and some metadata about the
// console's available modules.
func (c *Console) Welcome() {
	// Print some generic Gabs metadata
	fmt.Fprintf(c.printer, "Welcome to the Gabs JavaScript console!\n\n")
	c.jsre.Run(`
