...
)](https://godoc.org/github.com/ethereum/go-abs)
[![Go Report Card](https://goreportcard.com/badge/github.com/ethereum/go-abs)](https://goreportcard.com/report/github.com/ethereum/go-abs)
[![Travis](https://travis-ci.org/ethereum/go-abs.svg?branch=master)](https://travis-ci.org/ethereum/go-abs)
...
For prerequisites and detailed build instructions please read the [Installation Instructions](https://github.com/ethereum/go-abs/wiki/Building-Ethereum) on the wiki.
...
|    Command    | Description                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          |
| :-----------: | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
|  **`gabs`**   | Our main Ethereum CLI client. It is the entry point into the Ethereum network (main-, test- or private net), capable of running as a full node (default), archive node (retaining all historical state) or a light node (retrieving data live). It can be used by other processes as a gateway into the Ethereum network via JSON RPC endpoints exposed on top of HTTP, WebSocket and/or IPC transports. `gabs --help` and the [CLI Wiki page](https://github.com/ethereum/go-abs/wiki/Command-Line-Options) for command line options.          |
|   `abigen`    | Source code generator to convert Ethereum contract definitions into easy to use, compile-time type-safe Go packages. It operates on plain [Ethereum contract ABIs](https://github.com/ethereum/wiki/wiki/Ethereum-Contract-ABI) with expanded functionality if the contract bytecode is also available. However, it also accepts Solidity source files, making development much more streamlined. Please see our [Native DApps](https://github.com/ethereum/go-abs/wiki/Native-DApps:-Go-bindings-to-Ethereum-contracts) wiki page for details. |
...
[CLI Wiki page](https://github.com/ethereum/go-abs/wiki/Command-Line-Options)),
 ...
 * Start up `gabs`'s built-in interactive [JavaScript console](https://github.com/ethereum/go-abs/wiki/JavaScript-Console),
   (via the trailing `console` subcommand) through which you can invoke all official [`web3` methods](https://github.com/ethereum/wiki/wiki/JavaScript-API)
   as well as `gabs`'s own [management APIs](https://github.com/ethereum/go-abs/wiki/Management-APIs).
 ...
 * Instead of using the default data directory (`~/.ethereum` on Linux for example), `gabs`
...
this, `gabs` has built-in support for a JSON-RPC based APIs ([standard APIs](https://github.com/ethereum/wiki/wiki/JSON-RPC)
and [`gabs` specific APIs](https://github.com/ethereum/go-abs/wiki/Management-APIs)).
...
more complex changes though, please check up with the core devs first on [our gitter channel](https://gitter.im/ethereum/go-abs)
...
Please see the [Developers' Guide](https://github.com/ethereum/go-abs/wiki/Developers'-Guide)
